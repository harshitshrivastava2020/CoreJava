...
public class TestComparatorEmployee {
	public static void main(String[] args) {
		...
		OrderById OById = new OrderById();
		Collections.sort(list, OById);
		list.forEach(System.out::println);

		System.out.println("---sort by name---");

		OrderByName OByName = new OrderByName();
		Collections.sort(list, OByName);
		list.forEach(System.out::println);

		System.out.println("---sort by salary---");

		OrderBySalary OBySalary = new OrderBySalary();
		Collections.sort(list, OBySalary);
		list.forEach(System.out::println);
